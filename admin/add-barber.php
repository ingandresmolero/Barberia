...
if (strlen($_SESSION['bpmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into  tblbarber(nombre, porcentaje, usuario, pass) value('$adminName','$porcentaje','$userName','$contraseña')");
        if ($query) {
...
?>
    ...
    <head>
        <title>Activo | Agregar Barbero</title>
    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="forms">
                        <h3 class="title1">Agregar Barbero</h3>
                            ...
                            <div class="form-body">
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Nombre de Usuario para Barbero</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control" id="porcentaje" name="porcentaje" placeholder="Porcentaje" value="">
                                    </div>
                                    <!-- <div class="radio">
