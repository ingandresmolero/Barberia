...
if (strlen($_SESSION['bpmsaid'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		$assignedBy = $_SESSION['bpmsaid'];
		$barber = $_POST['barber'];


		$query = mysqli_query($con, "insert into  tblcustomers(Name,assignedbarber,Gender,Details,assignedBy) value('$name','$barber','$gender','$details','$assignedBy')");
		if ($query) {
						...
						<div class="form-grids row widget-shadow" data-example-id="basic-forms">
							...
							<div class="form-body">
								<form method="post">
									...
									<!-- <div class="form-group"> <label for="exampleInputPassword1">Correo</label> <input type="email" id="email" name="email" class="form-control" placeholder="Correo" value="" required="true"> </div> -->
							 ...
							 <div class="radio"> -->
									<div class="form-group"> <label for="exampleInputEmail1">Barbero</label>
										<div class="form-group">
											<select name="barber" id="barber">
												...
												$list_barber = mysqli_query($con, $consulta);
							...
							<div class="form-group"> <label for="exampleInputEmail1">Detalle</label> <textarea type="text" class="form-control" id="details" name="details" placeholder="Detalle" rows="4" cols="2"></textarea> </div>
