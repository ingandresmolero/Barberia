...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblcustomers(Name,Email,MobileNumber,Gender,Details,assignedBy) value('$name','$email','$mobilenum','$gender','$details','$assignedBy')");
    if ($query) {
