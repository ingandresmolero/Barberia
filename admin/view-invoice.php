...
<html>
<head>
<title>Activo | Detalle de Factura</title>
...
while ($row=mysqli_fetch_array($ret)) {
	...
	$retAdm=mysqli_query($con,"select AdminName from tbladmin where ID='$adid'");
	$rowAdm=mysqli_fetch_array($retAdm);
?>				
...
<th colspan="6">Detalles</th>	
							 ...
							 <tr> 
								<th>Nombre</th> 
								<td><?php echo $rowAdm['AdminName']?></td> 
							</tr> 							
